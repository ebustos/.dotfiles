...
syntax keyword lyxCommand  start=/\/ end=/ /
syntax keyword lyxCommand  \\layout
syntax keyword lyxCommand  \begin_layout
syntax keyword lyxCommand  \begin_
syntax keyword lyxCommand  \end_layout
syntax keyword lyxCommand  \end_
